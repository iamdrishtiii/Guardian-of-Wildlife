    ...
    <div>
      <div className="pb-[450px] 3xl:pb-48 md:pb-64">
        ...
        <div
          ...
          style={{
            backgroundImage:
              "url('https://as2.ftcdn.net/v2/jpg/04/30/10/49/1000_F_430104934_XkWgamRumD1A6nnEWE9YnIwV3xYagY24.jpg')",
            backgroundSize: "cover",
            backgroundPosition: "center",
          }}
        >
          <h2 className="text-4xl font-bold md:pt-10 lg:pt-16">
            Welcome to Our Blog
          </h2>
          <p className="text-2xl mt-2 font-semibold pt-4 md:pb-10 lg:pb-16">
            ...
            programs and wildlife initiatives.
          </p>
        </div>
        ...
        {loading ? (
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-2 lg:p-10">
            {currentBlogs.map((blog) => (
              <div
                key={blog.number}
                className="rounded-xl hover:bg-gray-100 px-10 py-4 h-fit flex justify-center text-center"
              >
                <Link to={`/blog/${blog.number}/${blog.BlogTitle}`}>
                  ...
                  <p
                    className="text-2xl font-bold flex flex-row gap-10 mt-4 flex justify-center"
                    data-testid="blogName"
                  >
                    {blog.BlogTitle} <FaArrowRight />
                  </p>
                </Link>
              </div>
            ))}
